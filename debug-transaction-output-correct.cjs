...
console.log('=== Correct Transaction Output Analysis ===');
...
for (let k = 0; k < outputCount.value; k++) {
    ...
    if (value === 1000000000000n) {
        ...
        // Extract the exact bytes for this output
        const outputStart = offset - 8 - tokenIdLen.bytesRead - tokenIdLen.value - scriptLen.bytesRead - scriptLen.value;
