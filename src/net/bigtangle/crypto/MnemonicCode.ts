...
export class MnemonicCode {
    ...
    private static ENGLISH_WORDLIST: string[] = [
        ...
        "barrel", "base", "basic", "basket", "battle", "beach", "bean", "bear", "beauty", "because",
        "become", "bed", "bee", "beef", "before", "begin", "behave", "behind", "believe", "below",
        ...
        "blast", "bleak", "bless", "blind", "blood", "blossom", "blouse", "blue", "blur", "board",
    ...
    constructor() {
        ...
        if (this.wordList.length !== 2048) {
            console.warn("English wordlist does not contain 2048 words, but proceeding anyway");
        }
    }
