export class MatchLastdayResult {
    ...
    private lastdayprice: number = 0;
    private lastdayQuantity: number = 0;
    ...
    constructor(
        ...
        if (lastdayprice !== undefined) this.lastdayprice = lastdayprice;
        if (lastdayQuantity !== undefined) this.lastdayQuantity = lastdayQuantity;
    }
    ...
    public getLastdayprice(): number {
        return this.lastdayprice;
    }

    public setLastdayprice(lastdayprice: number): void {
        this.lastdayprice = lastdayprice;
    }

    public getLastdayQuantity(): number {
        return this.lastdayQuantity;
    }

    public setLastdayQuantity(lastdayQuantity: number): void {
