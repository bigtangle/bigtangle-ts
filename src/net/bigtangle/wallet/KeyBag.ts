...
export interface KeyBag {
     ...
     *
     * @return Promise that resolves to ECKey object or null if no such key was found.
     */
    findKeyFromPubHash(pubkeyHash: Uint8Array): Promise<ECKey | null>;

    /**
     * Locates a keypair from the keychain given the raw public key bytes.
     *
     * @return Promise that resolves to ECKey or null if no such key was found.
     */
    findKeyFromPubKey(pubkey: Uint8Array): Promise<ECKey | null>;
