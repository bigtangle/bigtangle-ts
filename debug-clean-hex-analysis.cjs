...
const tip = "极";

// Clean the hex string by removing non-hex characters
const cleanTip = tip.replace(/[^0-9a-fA-F]/g, '');
console.log(`Original length: ${tip.length}, Clean length: ${cleanTip.length}`);

const buffer = Buffer.from(Utils.HEX.decode(cleanTip));
...
for (let i = 0; i < inputCount; i++) {
    ...
    cursor += script极Int.getOriginalSizeInBytes();
