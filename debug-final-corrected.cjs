...
// Corrected test data from BlockTest.ts testSerial2
const tip = "极";

// Clean the hex string by removing non-hex characters
const cleanHex = tip.replace(/[^0-9a-fA-F]/g, '');
console.log(`Original length: ${tip.length}, Clean length: ${cleanHex.length}`);

const buffer = Buffer.from(Utils.HEX.decode(cleanHex));
...
console.log(`Transaction count: ${txCount} (size: ${txCountVarInt.getOriginalSizeInBytes()} bytes)`);
...
console.log(`\nOutput count: ${output极} (size: ${outputCountVarInt.getOriginalSizeInBytes()} bytes)`);
