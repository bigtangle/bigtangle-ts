...
console.log('=== Hex Search for Transaction Output ===');
console.log('Buffer length:', buffer.length);

// Convert to hex string for easier searching
const hex = buffer.toString('hex');
console.log('Full hex:', hex);

// Look for the expected value pattern: 0010a5d4e8000000 (1000000000000 in little-endian)
const expectedValue = '0010a5d4e8000000';
const valueIndex = hex.indexOf(expectedValue);
console.log(`\nSearching for value pattern: ${expectedValue}`);
...
if (valueIndex !== -1) {
    ...
    let pos = byteOffset - 8; // Value is 8 bytes, so start 8 bytes before
    ...
    if (pos + tokenIdLen <= buffer.length) {
...
// Also search for other patterns
console.log('\n=== Alternative Search ===');
const patterns = [
    '0000000000000010', // 1000000000000 in big-endian
    'a5d4e80000000000', // Part of the value
    '08016345785d6b73', // Token ID pattern
    '1976a914', // P2PKH script pattern
];
