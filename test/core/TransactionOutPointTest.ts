...
describe('TransactionOutPointTest', () => {
    ...
    test('testSerialization', () => {
        ...
        const outpoint = new TransactionOutPoint(PARAMS, 123, blockHash, txHash);
    ...
    test('testSerializationWithZeroHashes', () => {
        ...
        const outpoint = new TransactionOutPoint(PARAMS, 456, Sha256Hash.ZERO_HASH, Sha256Hash.ZERO_HASH);
