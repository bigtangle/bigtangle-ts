...
export class FakeTxBuilder {
    ...
    public static createFakeTxWithoutChange(
        ...
        const input1 =   TransactionInput.fromOutpoint(params, tx, Buffer.from([]), prevTx.getOutput(0).getOutPointFor(genesisPubHash));
        tx.addInput(input1);
        return tx;
    }
    ...
    public static createFakeCoinbaseTx(params: NetworkParameters): Transaction {
        ...
        const input =  TransactionInput.fromOutpoint(params, null, Buffer.from([]), outpoint);
        const tx = new Transaction(params);
        tx.addInput(input);
    ...
    public static createFakeTxWithChangeAddress(
        ...
        // Connect it.
        const input =  TransactionInput.fromOutpoint(params, t, Buffer.from([]), prevOut.getOutPointFor(Sha256Hash.ZERO_HASH));
        t.addInput(input);
    ...
    public static createFakeTxWithoutChangeAddress(
        ...
        // Connect it.
        const input1 =  TransactionInput.fromOutpoint(params, t, Buffer.from([]), prevOut1.getOutPointFor(Sha256Hash.ZERO_HASH));
        t.addInput(input1);
        ...
        const input2 =  TransactionInput.fromOutpoint(params, t, Buffer.from([]), prevOut2.getOutPointFor(Sha256Hash.ZERO_HASH));
        t.addInput(input2);
    ...
    public static createFakeTxFrom(
        ...
        // Connect up the txes
        const feederInput =  TransactionInput.fromOutpoint(params, prevTx, Buffer.from([]), feederOut.getOutPointFor(Sha256Hash.ZERO_HASH));
        prevTx.addInput(feederInput);
        const mainInput =  TransactionInput.fromOutpoint(params, t, Buffer.from([]), prevOut.getOutPointFor(Sha256Hash.ZERO_HASH));
    ...
    public static createFakeDoubleSpendTxns(
        ...
        const inputT1 =  TransactionInput.fromOutpoint(params, doubleSpends.t1, Buffer.from([]), prevOut.getOutPointFor(Sha256Hash.ZERO_HASH));
        doubleSpends.t1.addInput(inputT1);

        doubleSpends.t2 = new Transaction(params);
        const inputT2 =  TransactionInput.fromOutpoint(params, doubleSpends.t2, Buffer.from([]), prevOut.getOutPointFor(Sha256Hash.ZERO_HASH));
